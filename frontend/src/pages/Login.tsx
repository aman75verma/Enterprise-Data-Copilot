    ...
    <>
      ...
      <div className="login-page">
        <div className="login-card glass">
          <div className="welcome-icon" style={{ margin: '0 auto 24px' }}>
            <Database size={30} color="#080c14" strokeWidth={2.5} />
          </div>

          <h1>Supabase Support Copilot</h1>
          <p className="login-sub">
            AI-powered internal tool for support agents.<br />
            Query customer data, search docs &amp; track live issues.
          </p>
          ...
          <button className="demo-btn" onClick={handleDemoLogin}>
            <Zap size={15} style={{ display: 'inline', verticalAlign: 'text-bottom', marginRight: 6 }} />
            Enter as Demo Agent
          </button>
